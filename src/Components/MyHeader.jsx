...
const MyHeader = () => {
  return (
    <header id="header">
      <div className="d-flex flex-column min-vh-100 bg-black bg-opacity-50 pt-10 pt-md-8 pb-md-0">
        <div className="container my-auto">
          <div className="row justify-content-center">
            <div className="col-12 col-md-8 col-lg-6 text-center">
              ...
              {/* Subheading */}
              <p className="text-center text-white text-opacity-75 mb-5">
            ...
            <div className="col-md">
              ...
              <ul className="list-inline text-center text-md-start mb-3 my-md-5">
                <li className="list-inline-item">
                  <a
                    className="text-white text-opacity-75 text-primary-hover"
                    href="#"
                  >
                    <svg
            ...
            <div className="col-md">
              ...
              <p className="font-serif text-white text-opacity-75 text-center text-md-end text-lg-end my-md-5">
                <svg
                  ...
                  height="16"
                  fill="currentColor"
                  className="bi bi-geo-alt-fill me-3 text-primary"
                  viewBox="0 0 16 16"
                >
