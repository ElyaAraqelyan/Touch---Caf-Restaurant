...
const Footer = () => {
  return (
    <footer className="py-5 py-md-9 bg-black">
        ...
        <div className="row gx-7">
          ...
          <div className="col-sm-4">
            ...
            <div className="mb-3">
              ...
              <div className="font-playfair">10:00 AM - 11:00 PM</div>
            </div>
            <div className="mb-6">
              <div className="text-xs">Friday - Sunday</div>
              <div className="font-playfair">12:00 AM - 03:00 AM</div>
            </div>
          </div>
        </div>
        <div className="row">
          <div className="col-12">
            ...
            <div className="d-flex align-items-center">
              <hr className="hr-sm me-3" style={{ height: "1px" }} />© 2021
              Touché. All rights reserved.
            </div>
          </div>
        </div>
      </div>
